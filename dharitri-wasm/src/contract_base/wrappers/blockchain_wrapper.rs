...
use crate::{
    ...
    storage::{self},
    types::{
        BigUint, DctLocalRoleFlags, DctTokenData, ManagedAddress, ManagedByteArray, ManagedType,
        TokenIdentifier,
    },
};
    ...
    A: BlockchainApi + ManagedTypeApi + ErrorApi,
{
    ...
    pub fn get_current_dct_nft_nonce(
        ...
        A::blockchain_api_impl().get_current_dct_nft_nonce::<A>(address, token_id)
    }
    ...
    pub fn get_dct_balance(
        ...
        A::blockchain_api_impl().get_dct_balance::<A>(address, token_id, nonce)
    }
    ...
    pub fn get_dct_token_data(
        ...
        A::blockchain_api_impl().get_dct_token_data::<A>(address, token_id, nonce)
    }

    pub fn get_dct_local_roles(&self, token_id: &TokenIdentifier<A>) -> DctLocalRoleFlags {
        A::blockchain_api_impl().get_dct_local_roles::<A>(token_id)
    }
}
